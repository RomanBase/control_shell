...
Future<void> buildAppBundle(
  ...
  await shell.run('flutter build appbundle --build-name $buildName --build-number $buildNumber ${args.join(' ')}');
}
...
Future<XmlDocument> manifestFromArchive(String dir, {String abb = 'app-release.aab', String bundletool = 'bundletool.jar'}) async {
...
Future<String> packageNameFromArchive(ControlShell shell, {String? dir, String abb = 'app-release.aab', String bundletool = 'bundletool.jar'}) async {
